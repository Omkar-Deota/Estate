...
export default function HomeEx() {
  const list = [
    { title: "Villa", img: img1, price: "$100k" },
    { title: "Tangi", img: img2, price: "$120k" },
    { title: "Raspberry", img: img3, price: "$130k" },
    { title: "Liverpool", img: img4, price: "$90k" },
    { title: "Avodo", img: img5, price: "$76k" },
    { title: "Limon", img: img6, price: "$130k" },
    { title: "Mannat", img: img7, price: "$140k" },
    { title: "Klassy", img: img8, price: "$135k" },
  ];
